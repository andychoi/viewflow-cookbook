...
WIDGET_RENDERERS = {
    ...
    widgets.FormWidget: FormWidgetRenderer,
    widgets.FormSetWidget: FormSetWidgetRenderer,
    widgets.InlineCalendar: InlineCalendarRenderer,
    widgets.AjaxModelSelect: AjaxModelSelectRenderer,
    widgets.AjaxMultipleModelSelect: AjaxMultipleModelSelectRenderer,
    widgets.DependentModelSelect: DependentSelectRenderer,
    widgets.TrixEditorWidget: TrixEditorRenderer,
}
