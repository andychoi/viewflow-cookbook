...
from workflow101.helloworld.flows import HelloWorldFlow
from workflow101.bloodtest.flows import BloodTestFlow
from workflow101.dynamic_split.flows import DynamicSplitFlow
from workflow101.shipment.flows import ShipmentFlow
from workflow101.shipment.viewsets import ShipmentViewset, CarierViewset
from workflow101.sub.flows import OrderItemFlow, CustomerVerificationFlow, OrderFlow
...
urlpatterns = [
    ...
    path("", include("workflow101.hellorest.urls")),
    path("", site.urls),
]
